                                ...
                                <tbody style="background-color: white;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="vertical-align: middle;">
                                            <form onsubmit="return confirm('Apakah Anda Yakin ingin meminjam ini ?');" action="{{ route('create', $item->id_buku) }}" method="Post"class="d-inline">
                                                @csrf
                                                <button type="submit" class="border-0 bg-transparent text-primary"><i class="fa-solid fa-plus"></i></button>
                                            </form>
                                        </td>
                                    </tr>
                                    @empty
